...
<ul class="nav nav-font pull-right">
    <li class="dropdown"><a href="" class="dropdown-toggle" data-toggle="dropdown" style="padding: 7px 3px 6px;">
        <span class="label label-info" style="padding: 6px 8px;"><i class="icon-wrench icon-white">
        </i></span></a>
